...
const { createDeliveryNote, getDeliveryNotes, getDeliveryNoteById, updateDeliveryNote, deleteDeliveryNote, getDeliveryNotePDF } = require("../controllers/delivery-note");
...
router.get("/:id/pdf", authMiddleware, getDeliveryNotePDF);
